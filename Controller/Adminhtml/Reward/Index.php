...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $this->_view->getPage()->setActiveMenu('Carbonclick_CFC::cfc_reward');
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Climate Friendly Rewards'));
    ...
    {
        return $this->_authorization->isAllowed('Carbonclick_CFC::cfc_reward');
    }
}
